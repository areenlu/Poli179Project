...
class marmot(nn.Module):
    def __init__(self, bert_model, image_model, pretrained_image_channels=10, pretrained_image_dim=10, bert_dim=768,
        ...
        # Image Translator
        self.ImageTranslator = image_transformer(self.bert_model, image_model, pretrained_image_channels=pretrained_image_channels, pretrained_image_dim=pretrained_image_dim, bert_dim=bert_dim)
