...
def binary_trainer(model, train_dataset, validation_dataset, epochs, learning_rate, batch_size,
    ...
    adpt_train_dataset = PandasDataset(train_dataset)
    
    adpt_validation_dataset = PandasDataset(train_dataset)

    train_dataloader = DataLoader(adpt_train_dataset,
                                  sampler = RandomSampler(train_dataset),
                                  batch_size = batch_size)

    validation_dataloader = DataLoader(adpt_validation_dataset)
...
def binary_trainer_text(model, train_dataset, validation_dataset, epochs, learning_rate, batch_size,
    ...
    train_dataloader = DataLoader(adpt_train_dataset,
                                  sampler = RandomSampler(adpt_train_dataset),
                                  batch_size = batch_size)
